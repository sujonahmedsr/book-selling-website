                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-1 gap-5 relative md:h-fit bg-white">
                    ...
                    <div className="lg:col-span-9 col-span-1 text-base">
                        <div className="space-y-1">
                            ...
                            <h1 className="text-base text-gray-700">লেখক : <span className="">{author?.name}</span></h1>
                            <p className=" text-gray-700">প্রকাশনী : <span className="text-red-500 ">{publication?.name}</span></p>
                            <p className=" text-gray-700">বিষয় : <span className="text-red-500">{subject?.name}</span></p>
