import { useAboutUsQuery } from "../../RTK/Fearures/getBook/getBookApi";
import Markdown from 'react-markdown'
import rehypeRaw from "rehype-raw";

const AboutUs = () => {
    const { data: aboutUs, isLoading, isError, error } = useAboutUsQuery()
    ...
    let content;
        ...
        if (!isLoading && !isError) {
            content = <div>
                ...
                <Markdown className='text-sm' rehypePlugins={[rehypeRaw]}>{aboutUs?.data?.content}</Markdown>
            </div>
